...
class FluidData(fCubicSpline):
    ...
    with other formats of fluid data.

    CURRENTLY BEING BUILT FOR VTK DATA ONLY, SINCE THAT IS THE ONLY 3D 
    ...
    def __init__(self, path, data_type='IB2d', d_start=0, d_finish=None, 
        ...
        '''
        self.LNUM = 8 # number of data files to have loaded at any time
