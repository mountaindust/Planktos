...
#   There is nothing to see between steps here, so play it back at 2 simulated
#   seconds per second of video (2x fast forward); at dt=0.1 that supports up to
#   20 fps.
swrm.plot_all('ex_2d_ind_var.mp4', fps=20, playback_rate=2, plot_heading=False)
# swrm.plot_all()