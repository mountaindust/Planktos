...
def test_intersection_methods():
    ...
    assert planktos._geom.seg_intersect_2D(p0, p1, p2, p3) is None
    ...
    assert planktos._geom.seg_intersect_2D(p0, p1, p2, p3) is not None
    ...
    assert planktos._geom.seg_intersect_2D(p0, p1, Q0_list, Q1_list) is None
    
    # Many segments, one intersection
    p0 = np.array([0.0, 0.0]); p1 = np.array([1., 1.])
    Q0_list = np.array([[0., 1.],[0., 1.],[0.25, 0.75]])
    Q1_list = np.array([[0., 2.],[1., 2.],[0.75, 0.25]])
    assert planktos._geom.seg_intersect_2D(p0, p1, Q0_list, Q1_list) is not None
    ...
    intersection = planktos._geom.seg_intersect_2D(seg0, seg1, Q0_list, Q1_list)
    ...
    tri0 = np.array([1., 1., 1.]); tri1 = np.array([2., 1., 1.])
    tri2 = np.array([1., 2., 1.])
    assert planktos._geom.seg_intersect_3D_triangles(seg0, seg1, tri0, tri1, tri2) is None
    ...
    tri2 = np.array([1., 4., 1.])
    intersection = planktos._geom.seg_intersect_3D_triangles(seg0, seg1, tri0, tri1, tri2)
