...
Beyond simulation, some analysis tools are available. 2D vorticity of the
velocity field can be computed, saved, and plotted via
``Environment.get_2D_vorticity``, ``save_2D_vorticity``, and ``plot_2D_vort``.
